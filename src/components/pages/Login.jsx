    ...
    <div className="page-login">
        ...
        <div className="login flex flex-col w-full md:w-1/2 xl:w-2/5 2xl:w-2/5 3xl:w-1/3 mx-auto p-8 md:p-10 md:pt-1 2xl:p-12 3xl:p-14 bg-[#ffffff] rounded-2xl shadow-xl">
            ...
            <form className="flex flex-col" onSubmit={loginUser}>
                ...
                <div className="pb-6">
                    <label htmlFor="password" className="block mb-2 text-sm font-medium text-[#111827]">Contraseña</label>
                    <div className="relative text-gray-400">
                        <span className="absolute inset-y-0 left-0 flex items-center p-1 pl-3">
                ...
                <div className="text-sm font-light text-[#6B7280] ">Todavía no tienes una cuenta?  <Link to={"/usuario/registrar-cuenta"} className="font-medium text-[#1e1e25] hover:underline">Crea una</Link>
